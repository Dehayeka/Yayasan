    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-7 col-xl-7">
        <div class="section-heading center-heading">
          ...
          <h3>For more information about our programs, get in touch</h3>
        </div>
      </div>
    </div>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4">
        <div class="row">
          ...
          <div class="col-lg-12 col-md-6">
            <div class="contact-item">
              <p>Office</p>
              <h4>Jl. Dr. Sujono No. 15, Mataram, Lombok, NTB</h4>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-8">
        <form class="contact__form form-row" method="post" action="mail.php" id="contactForm">
          ...
          <div class="row">
            <div class="col-lg-6"><input type="text" name="name" class="form-control" placeholder="Your Name"></div>
            <div class="col-lg-6"><input type="email" name="email" class="form-control" placeholder="Email Address"></div>
            <div class="col-lg-12"><input type="text" name="subject" class="form-control" placeholder="Subject"></div>
            <div class="col-lg-12"><textarea name="message" rows="6" class="form-control" placeholder="Your Message"></textarea></div>
          </div>
      ...
      <div class="col-lg-6 col-md-8">
        <div class="widget footer-about mb-4 text-center">
          ...
          <ul class="list-unstyled footer-info">
            <li><span>Ph:</span> +62 xxxxxxxxx</li>
            <li><span>Email:</span> xxxxx@gmail.com</li>
            <li><span>Location:</span> Jl. Dr. Sujono No. 15, Mataram, Lombok</li>
          </ul>
