           ...
           <div class="col-xl-12">
                <div style="width:100%; height:450px;">
                    <iframe
                      ...
                      src="https://www.google.com/maps?q=-8.6150363,116.1228922&z=17&output=embed">
                    </iframe>
                </div>
           </div>
       </div>
            ...
            <div class="col-lg-4">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="contact-item">
                            <p>Office</p>
                            <h4>Jl. Dr. Sujono No. 15, Mataram, NTB</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <form class="contact__form form-row" method="post" action="mail.php" id="contactForm">
                   ...
                   <div class="row">
                       ...
                       <div class="col-lg-12">
                           <div class="form-group">
                               <textarea name="message" cols="30" rows="6" class="form-control" placeholder="Your Message"></textarea>
                           </div>
                       </div>
                   </div>
            ...
            <div class="col-lg-6 col-md-8">
                <div class="widget footer-about mb-4 text-center">
                    ...
                    <ul class="list-unstyled footer-info">
                        ...
                        <li><span>Location:</span> Jl. Dr. Sujono No. 15, Mataram, NTB</li>
                    </ul>
